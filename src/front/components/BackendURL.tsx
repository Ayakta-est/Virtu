...
const Dark: FC<DarkProps> = ({ children }) => (
...
export const BackendURL: FC = () => (
  <div className="mt-5 pt-5 w-50 mx-auto">
    ...
    <ol>
      ...
      <li>
        Replace <Dark>your api host</Dark> with the public API URL of your Flask backend server running at port 3001
      </li>
    </ol>
    <div className="w-100">
      <img src={envFile} alt="Example .env file" className="w-100" />
    </div>
    <p>
      <strong>Note:</strong> If you are publishing your website to Heroku, Render.com or any other hosting you probably need to follow other steps.
    </p>
  </div>
);
